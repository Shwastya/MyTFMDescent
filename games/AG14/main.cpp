...
int main(int, char* []) {
    ...
    const Shader s_phong("../games/AG14/phong.vs", "../games/AG14/blinn.fs");
    const Shader s_depth("../games/AG14/depth.vs", "../games/AG14/depth.fs");
    const Shader s_debug("../games/AG14/debug.vs", "../games/AG14/debug.fs");
    const Shader s_light("../games/AG14/light.vs", "../games/AG14/light.fs");
