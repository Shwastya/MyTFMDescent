...
namespace MHelmet {
	...
	struct OnWindowResize : public Event
	{
		...
		virtual inline std::string GetName() const override { return "WndowResize"; }
	private:
	...
	struct OnAppTick : public Event
	{
		...
		virtual inline std::string GetName() const override { return "AppTick"; }
	};
	...
	struct OnAppUpdate : public Event
	{
		...
		virtual inline std::string GetName() const override { return "AppUpdate"; }
	};
	...
	struct OnAppRender : public Event
	{
		...
		virtual inline std::string GetName() const override { return "AppRender"; }
	};
}